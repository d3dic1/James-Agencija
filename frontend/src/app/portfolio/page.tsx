...
const projects = [
  {
    ...
    description: 'Complete redesign and optimization of an online store, resulting in a 150% increase in conversion rate.',
  ...
  },
  {
    ...
    description: 'Viral social media campaign that generated over 1M impressions and 50K new followers.',
  ...
  },
  {
    ...
    category: 'SEO',
    client: 'B2B Software',
    href: '/portfolio/seo-optimization',
  },
  {
    name: 'Brand Identity',
  ...
  },
  {
    ...
    description: 'Content strategy that generated 500+ leads and increased engagement by 75%.',
    imageUrl: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=500&q=80',
    category: 'Content',
    client: 'Financial Services',
    href: '/portfolio/content-marketing',
  },
  {
    name: 'PPC Campaign',
    description: 'Targeted PPC campaign with 300% ROI and 50% reduction in cost per acquisition.',
    imageUrl: 'https://images.unsplash.com/photo-1465101178521-c1a9136a3b99?auto=format&fit=crop&w=500&q=80',
    category: 'PPC',
    client: 'E-commerce Brand',
    href: '/portfolio/ppc-campaign',
  },
];

const categories = ['All', 'Web Design', 'Social Media', 'SEO', 'Branding', 'Content', 'PPC'];
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Explore our successful projects and case studies. Each one represents our commitment to
            ...
            {projects.map((project) => (
              <div key={project.name} className="group relative">
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-2 text-base font-semibold text-gray-900">{project.description}</p>
