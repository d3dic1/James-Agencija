...
const contactInfo = [
  {
    title: 'Office',
    description: '123 Marketing Street, Suite 100, New York, NY 10001',
    icon: (
  ...
  {
    title: 'Email',
    description: 'hello@marketingagency.com',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path
          strokeLinecap="round"
            ...
            <div className="lg:pl-8">
              <div className="space-y-8">
                {contactInfo.map((item) => (
                  <div key={item.title} className="flex items-center gap-x-6">
